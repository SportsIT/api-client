...
class DocumentTest extends TestCase {
  ...
  public function it_returns_a_boolean_indicating_if_it_has_errors() {
    $document = new Document();
    $this->assertEquals(true, $document->isSuccess());
    $this->assertEquals(false, $document->hasErrors());
    ...
    $this->assertEquals(true, $document->hasErrors());
    $this->assertEquals(false, $document->isSuccess());
  }
